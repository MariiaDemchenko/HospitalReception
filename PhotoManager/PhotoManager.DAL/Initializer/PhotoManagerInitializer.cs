...
namespace PhotoManager.DAL.Initializer
{
    public class PhotoManagerInitializer : DropCreateDatabaseIfModelChanges<PhotoManagerDbContext>
    {
        protected override void Seed(PhotoManagerDbContext context)
        {
            ...
            {
                //colors
                new Photo {Place = "Place0", OwnerId = userId, Name = "Black", CreationDate = new DateTime(2018, 05, 05, 05, 05, 0), CameraSettingsId = 1},
                new Photo {Place = "Place1", OwnerId = userId, Name = "Blue", CreationDate = new DateTime(2018, 05, 05, 05, 05, 0), CameraSettingsId = 2},
                new Photo {Place = "Place2", OwnerId = userId, Name = "Brown", CreationDate = new DateTime(2018, 02, 02, 02, 02, 0), CameraSettingsId = 3},
                new Photo {Place = "Place3", OwnerId = userId, Name = "Colors", CreationDate = new DateTime(2018, 02, 02, 02, 02, 0), CameraSettingsId = 4},
                new Photo {Place = "Place4", OwnerId = userId, Name = "DarkBlue", CreationDate = new DateTime(2018, 02, 02, 02, 02, 0), CameraSettingsId = 5},
                new Photo {Place = "Place5", OwnerId = userId, Name = "Gray", CreationDate = new DateTime(2018, 05, 05, 05, 05, 0), CameraSettingsId = 6},
                new Photo {Place = "Place6", OwnerId = userId, Name = "Green", CreationDate = new DateTime(2018, 05, 05, 05, 05, 0), CameraSettingsId = 7},
                new Photo {Place = "Place7", OwnerId = userId, Name = "Lavender", CreationDate = new DateTime(2018, 05, 05, 05, 05, 0), CameraSettingsId = 8},
                new Photo {Place = "Place8", OwnerId = userId, Name = "Limegreen", CreationDate = new DateTime(2018, 05, 05, 05, 05, 0), CameraSettingsId = 9},
                new Photo {Place = "Place9", OwnerId = userId, Name = "Orange", CreationDate = new DateTime(2018, 05, 05, 05, 05, 0), CameraSettingsId = 10},
                new Photo {Place = "Place10", OwnerId = userId, Name = "Pink", CreationDate = new DateTime(2018, 05, 05, 05, 05, 0), CameraSettingsId = 11},
                new Photo {Place = "Place11", OwnerId = userId, Name = "Purple", CreationDate = new DateTime(2018, 04, 04, 04, 04, 0), CameraSettingsId = 12},
                new Photo {Place = "Place12", OwnerId = userId, Name = "Red", CreationDate = new DateTime(2018, 05, 05, 05, 05, 0), CameraSettingsId = 13},
                new Photo {Place = "Place13", OwnerId = userId, Name = "Skyblue", CreationDate = new DateTime(2018, 05, 05, 05, 05, 0), CameraSettingsId = 14},
                new Photo {Place = "Place14", OwnerId = userId, Name = "Sunrize", CreationDate = new DateTime(2018, 05, 05, 05, 05, 0), CameraSettingsId = 15},
                new Photo {Place = "Place15", OwnerId = userId, Name = "Turqoise", CreationDate = new DateTime(2018, 05, 05, 05, 05, 0), CameraSettingsId = 16},
                ...
                new Photo {Place = "Place19", OwnerId = userId, Name = "Yellow", CreationDate = new DateTime(2018, 02, 02, 02, 02, 0), CameraSettingsId = 20},
