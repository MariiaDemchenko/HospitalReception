...
{
    public class CashMachineInitializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<CashMachineContext>
    {
        protected override void Seed(CashMachineContext context)
        {
            ...
            var options = new List<Action>
            {
                ...
                new Action{Id = 2, Description = Constants.GetCashDescription}
            };
